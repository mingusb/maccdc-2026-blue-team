...
| --- | --- | --- | --- | --- | --- |
| Ecom web | tcp | 80,443 | 172.25.20.<team#>.11 | 172.20.242.30 | Ubuntu Ecom |
| Windows web | tcp | 80,443 | 172.25.20.<team#>.140 | 172.20.240.101 | IIS |
| SMTP | tcp | 25 (maybe 587) | 172.25.20.<team#>.39 | 172.20.242.40 | Fedora Webmail |
| POP3 | tcp | 110 (maybe 995) | 172.25.20.<team#>.39 | 172.20.242.40 | Fedora Webmail |
| DNS | udp/tcp | 53 | 172.25.20.<team#>.155 | 172.20.240.102 | AD/DNS |
| FTP control | tcp | 21 | 172.25.20.<team#>.162 | 172.20.240.104 | Server 2022 FTP |
| FTP passive | tcp | <passive_range> | 172.25.20.<team#>.162 | 172.20.240.104 | Must match IIS config |
